...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(70, 90, 222, 129))
        ...
        self.set_avatar = QtWidgets.QPushButton(self.layoutWidget)
        self.set_avatar.setObjectName("set_avatar")
        self.verticalLayout_2.addWidget(self.set_avatar)
        ...
        self.error.setGeometry(QtCore.QRect(300, 90, 101, 16))
        ...
        self.avatar_img.setGeometry(QtCore.QRect(310, 120, 80, 80))
